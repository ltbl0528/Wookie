...
public class PostShortAdapter extends RecyclerView.Adapter<PostShortAdapter.PostViewHolder> {
    private String TAG = "PostShortAdapter";
    ...
    public PostShortAdapter(ArrayList<Post> postList, Context context){
    ...
    @NonNull
    @Override
    public PostShortAdapter.PostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_post_place_info, parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull PostShortAdapter.PostViewHolder holder, int position) {
        // 프로필 사진, 이름 설정
