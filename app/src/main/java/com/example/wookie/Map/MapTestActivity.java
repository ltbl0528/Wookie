...
public class MapTestActivity extends AppCompatActivity implements MapView.MapViewEventListener, MapView.POIItemEventListener, MapView.OpenAPIKeyAuthenticationResultListener, View.OnClickListener, MapView.CurrentLocationEventListener {
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.fab_detail:
                ...
                Intent detailIntent = new Intent(MapTestActivity.this, MapSearchDetailActivity.class);
                                                                                                            ...
                                                                                                            public void onResponse(@NotNull Call<CategoryResult> call, @NotNull Response<CategoryResult> response) {
                                                                                                                if (response.isSuccessful()) {
                                                                                                                    ...
                                                                                                                    MapCircle circle1 = new MapCircle(
                                                                                                                            ...
                                                                                                                            1000, // radius
                                                                                                                            Color.argb(0, 0, 255, 0), // strokeColor
                                                                                                                            Color.argb(0, 255, 0, 0) // fillColor
                                                                                                                    );
                                                                                                                    circle1.setTag(5678);
                ...
                if (index == 0) {
                    ...
                    call.enqueue(new Callback<CategoryResult>() {
                        ...
                        public void onResponse(@NotNull Call<CategoryResult> call, @NotNull Response<CategoryResult> response) {
                            mLoaderLayout.setVisibility(View.GONE);
                            if (response.isSuccessful()) {
                                Intent intent = new Intent(MapTestActivity.this, PlaceDetailActivity.class);
                                assert response.body() != null;
