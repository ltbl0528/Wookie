...
public class SelectPlaceActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        LocationAdapter locationAdapter = new LocationAdapter(documentArrayList, getApplicationContext(), searchTxt, recyclerView);
        ...
        Intent intent = new Intent(SelectPlaceActivity.this, LocationAdapter.class);
